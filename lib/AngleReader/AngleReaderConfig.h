...
// Die Magnetometer-Kalibrierung stand frueher hier (MAG_CALIBRATION_VERIFIED,
// MAG_A, MAG_B) und galt damit fuer jede Einheit, die diesen Build bekam. Sie
// ist aber einbauspezifisch und liegt jetzt pro MAC in der Tabelle in
// lib/UnitIdentity/UnitIdentity.cpp — mitsamt der Messprotokolle, die frueher
// als Kommentar an dieser Stelle standen.
//
// Alles oberhalb bleibt hier: Abtastrate, Boot-Gates und EKF-Rauschen sind
// Eigenschaften des Sensortyps und der Anwendung, nicht der einzelnen Einheit.
